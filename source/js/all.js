...
$(document).ready(function(){
    $('.kind_lists li a').on('click',(function(){
        ...
        if(name == "web"){
            ...
            TweenMax.to(".app",0.6,{opacity:"0",ease: Power2.easeOut});
            TweenMax.to(".banner",0.6,{opacity:"0",ease: Power2.easeOut});
            ...
            TweenMax.to(".app",0.6,{opacity:"1",ease: Power2.easeOut});
            TweenMax.to(".web",0.6,{opacity:"0",ease: Power2.easeOut});
            TweenMax.to(".banner",0.6,{opacity:"0",ease: Power2.easeOut});
            $(".kind_lists a").removeClass("active");
            ...
            TweenMax.to(".app",0.6,{opacity:"0",ease: Power2.easeOut});
            TweenMax.to(".web",0.6,{opacity:"0",ease: Power2.easeOut});
            TweenMax.to(".banner",0.6,{opacity:"1",ease: Power2.easeOut});
            ...
            TweenMax.to(".web,.app,.banner",0.6,{opacity:"1",ease: Power2.easeOut});
